...
const icons = {
  ...
  users: (
    <>
      ...
      <path d="M16 10a2.5 2.5 0 0 0 0-5" />
      <path d="M18 20a4.5 4.5 0 0 0-3-4.2" />
    </>
  ),
  personAdd: (
    <>
  ...
  link: (
    <>
      <path d="M10 13a5 5 0 0 0 7.1.1l1.4-1.4a5 5 0 0 0-7.1-7.1L10.6 5.4" />
      <path d="M14 11a5 5 0 0 0-7.1-.1l-1.4 1.4a5 5 0 0 0 7.1 7.1l.8-.8" />
    </>
  ),
  lock: (
    <>
